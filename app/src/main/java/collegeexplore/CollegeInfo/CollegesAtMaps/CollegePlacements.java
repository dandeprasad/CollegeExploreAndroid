...
public class CollegePlacements extends RecyclerView.Adapter<CollegePlacements.ViewHolder> {
    ...
    public CollegePlacements(Bitmap[] arrayOfBitmap, Integer[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public CollegePlacements.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        // create a new view
