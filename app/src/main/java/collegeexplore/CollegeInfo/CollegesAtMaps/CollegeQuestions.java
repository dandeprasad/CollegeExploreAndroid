...
public class CollegeQuestions extends RecyclerView.Adapter<CollegeQuestions.ViewHolder> {
    ...
    public CollegeQuestions(Bitmap[] arrayOfBitmap, Integer[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public CollegeQuestions.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                          int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.college_questions, parent, false);
