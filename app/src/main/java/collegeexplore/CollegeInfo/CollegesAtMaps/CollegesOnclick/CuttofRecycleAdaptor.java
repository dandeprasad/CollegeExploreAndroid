...
public class CuttofRecycleAdaptor extends RecyclerView.Adapter<CuttofRecycleAdaptor.ViewHolder> {
...
private Context contextadatptor;
    ...
    public CuttofRecycleAdaptor(ArrayList<String> maincontents, Context context) {
    ...
    @Override
    public CuttofRecycleAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        // create a new view
    ...
    //    holder.label.setText(mDataset[position]);
        ...
        try {
            ...
            Picasso.with(contextadatptor).load(imageserver+mDataset.get(position)).into(holder.imageView);
