...
public class FestsMapsFragment extends Fragment implements FestsMapsAdaptor.OnItemClickListener {
    String  COLLEGE_ID;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static FestsMapsFragment newInstance(String COLLEGE_ID) {
        FestsMapsFragment f = new FestsMapsFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new FestsMapsAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_MAPS_FESTDATA";
        String ACTION_ID = "GET_MAPS_FESTDATA";
...
if(null!=banner_logos) {
    Picasso.with(contextForFragment).load(banner_logos).into(dande);
                   ...
                   /* Button fg =xtest.findViewById(R.id.moreinfo);
                ...
                Button festregister = xtest.findViewById(R.id.registerfestonmap);

                festregister.setOnClickListener(new View.OnClickListener() {
