...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    */
    ...
    public static JSONObject filtersSelected=new JSONObject();
    private JSONArray filtersChild1=new JSONArray();
    private    JSONArray filtersChild2=new JSONArray();
    private    JSONArray filtersChild3=new JSONArray();
    ...
    */
    public ExpandableListAdapter(Context context, ArrayList<String> listDataGroup, HashMap<String, List<String>> listDataChild){
        ...
        filtersChild3.put("");
            ...
            filtersSelected.put("STREAMS",filtersChild3);

        filtersSelected.put("STATES",filtersChild1);
        filtersSelected.put("CITIES",filtersChild2);
        ...
        childViewHolder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    boolean getChecked[] = mChildCheckStates.get(mGroupPosition);
                    String val=   buttonView.getText().toString();
                   // filtersSelected.add(val);
                 String header =   mListDataGroup.get(mGroupPosition);
                 if(header.equalsIgnoreCase("States")){
                     filtersChild1.put(val);
                     filtersSelected.put("STATES",filtersChild1);

                 }
                    if(header.equalsIgnoreCase("Cities")){
                        filtersChild2.put(val);
                        filtersSelected.put("CITIES",filtersChild2);
                    }
                    if(header.equalsIgnoreCase("Departments")){
                        filtersChild3.put(val);
                        filtersSelected.put("STREAMS",filtersChild3);
                    }
                    ...
                    if(filtersChild1.equals(buttonView.getText().toString())){
                        filtersSelected.remove(buttonView.getText().toString());
                    }
                    boolean getChecked[] = mChildCheckStates.get(mGroupPosition);
                    getChecked[mChildPosition] = isChecked;
                    mChildCheckStates.put(mGroupPosition, getChecked);
