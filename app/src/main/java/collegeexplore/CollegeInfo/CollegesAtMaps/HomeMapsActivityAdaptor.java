...
public class HomeMapsActivityAdaptor extends RecyclerView.Adapter<HomeMapsActivityAdaptor.ViewHolder> {
    ...
    public HomeMapsActivityAdaptor(ArrayList maincontents, Integer[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public HomeMapsActivityAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
