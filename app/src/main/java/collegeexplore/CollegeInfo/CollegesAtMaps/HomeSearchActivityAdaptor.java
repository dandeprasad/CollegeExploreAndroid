...
public class HomeSearchActivityAdaptor extends RecyclerView.Adapter<HomeSearchActivityAdaptor.ViewHolder> {
    ...
    public HomeSearchActivityAdaptor(ArrayList maincontents, Integer[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public HomeSearchActivityAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.drawer_list_item_map, parent, false);
