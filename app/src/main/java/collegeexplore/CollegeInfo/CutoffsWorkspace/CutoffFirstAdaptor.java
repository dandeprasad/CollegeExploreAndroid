...
public class CutoffFirstAdaptor extends RecyclerView.Adapter<CutoffFirstAdaptor.carrerGuidanceViewHolder> implements ListOfNitsNews.OnItemClickListener,MainHeaderAdsAdaptor.OnItemClickListener {
  ...
  public  ArrayList<HashMap> ImagesArray=new ArrayList<HashMap>();
    ...
    public CutoffFirstAdaptor(OnItemClickListener listener, Context contextForFragment, Bitmap[] arrayOfBitmap, ArrayList<HashMap<String, String>> stringData) {
    ...
    @Override
    public CutoffFirstAdaptor.carrerGuidanceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
