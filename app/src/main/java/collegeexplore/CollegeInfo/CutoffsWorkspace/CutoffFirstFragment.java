...
public class CutoffFirstFragment extends Fragment implements CutoffFirstAdaptor.OnItemClickListener {
    int mNum;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static CutoffFirstFragment newInstance() {
        CutoffFirstFragment f = new CutoffFirstFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.steams);
      ...
      /*  ProgressBar spinner = new android.widget.ProgressBar(
       ...
       //contextForFragment.findViewById(R.id.loadingPanel).setVisibility(View.VISIBLE);
        ...
        //StringData.clear();
        mAdapter = new CutoffFirstAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
ArrayList<String> datatohost=new ArrayList<String>();
        ...
        Fragment fr =  CutoffSecondFragment.newInstance(position, UniqueKey,datatohost);
