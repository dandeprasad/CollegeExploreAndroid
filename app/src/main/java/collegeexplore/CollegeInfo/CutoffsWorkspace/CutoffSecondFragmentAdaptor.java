...
public class CutoffSecondFragmentAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
private ArrayList<Bitmap> imagedata;
    ...
    public CutoffSecondFragmentAdaptor(Context contextForFragment, ArrayList<HashMap> maincontents, ArrayList<Bitmap> imageId, OnItemClickListener listener) {
...
/*            if (position==0){
                ...
                holder.imageView.setPadding(0,0,0,0);
                        ...
                        if(!values.isEmpty()){
                            ...
                            Picasso.with(contextForFragmentadp).load((String)values.get("CLG_LOGO")).into( ((NewsViewHolder) holder).newsimglogo);
