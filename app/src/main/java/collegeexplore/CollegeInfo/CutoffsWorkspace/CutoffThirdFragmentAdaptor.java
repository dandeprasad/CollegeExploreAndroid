...
public class CutoffThirdFragmentAdaptor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
public Button ROUND;
    ...
    public CutoffThirdFragmentAdaptor(Context contextForFragment, ArrayList<ArrayList> maincontents, ArrayList<String> imageId, OnItemClickListener listener) {
        ...
        if(getItemViewType(position)==TYPE_NEWS) {
            ...
            if (!(mDataset.isEmpty())) {
               ...
               // TextView bal111 = UpdateAsyncdataheader1("JEE Entrance 2017");
                ...
                ((NewsViewHolder) holder).stk1.setText(contextForFragmentadp.getString(R.string.jee_entrnace_2017));
             ...
             //   Drawable xw = contextForFragmentadp.getResources().getDrawable(R.drawable.textinputborder1);
                ...
                TextView bal2 = UpdateAsyncdataheader(contextForFragmentadp.getString(R.string.Quota)+" OS (OR)");
                TextView bal3 = UpdateAsyncdataheader(contextForFragmentadp.getString(R.string.Quota)+"  OS (CR)");
                TextView bal4 = UpdateAsyncdataheader(contextForFragmentadp.getString(R.string.Quota)+"  HS (OR)");
                TextView bal5 = UpdateAsyncdataheader(contextForFragmentadp.getString(R.string.Quota)+"  HS (OR)");
...
/*            if (position==0){
                ...
                holder.label.setLayoutParams(params);
                    ...
                    TextView val2 = UpdateAsyncdata((String) values.get("QUOTA_OS_OR"));
                    TextView val3 = UpdateAsyncdata((String) values.get("QUOTA_OS_CR"));
                    TextView val4 = UpdateAsyncdata((String) values.get("QUOTA_HS_OR"));
