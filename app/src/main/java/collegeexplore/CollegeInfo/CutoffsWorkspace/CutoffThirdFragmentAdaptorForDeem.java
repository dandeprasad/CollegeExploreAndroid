...
public class CutoffThirdFragmentAdaptorForDeem extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
public Button ROUND;
    ...
    public CutoffThirdFragmentAdaptorForDeem(Context contextForFragment, ArrayList<ArrayList> maincontents, ArrayList<String> imageId, OnItemClickListener listener) {
