...
public class CutoffThirdFragmentAdaptorForIIIT extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
public Button ROUND;
    ...
    public CutoffThirdFragmentAdaptorForIIIT(Context contextForFragment, ArrayList<ArrayList> maincontents, ArrayList<String> imageId, OnItemClickListener listener) {
