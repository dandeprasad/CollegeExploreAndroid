...
public class ExamsFragmentAdaptor extends RecyclerView.Adapter<ExamsFragmentAdaptor.ViewHolder> {
    ...
    public ExamsFragmentAdaptor(ArrayList<HashMap> maincontents, Bitmap[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public ExamsFragmentAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.news_main_layout, parent, false);
