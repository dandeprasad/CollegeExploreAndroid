...
public class FestsEventDetailsAdaptor extends RecyclerView.Adapter<FestsEventDetailsAdaptor.carrerGuidanceViewHolder>  {
  ...
  public  ArrayList<HashMap> ImagesArray=new ArrayList<HashMap>();
    ...
    public  class carrerGuidanceViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView fest_data_fest_workshop,fest_data_fest_eventdetails,fest_data_fest_paper;
        public carrerGuidanceViewHolder(View v) {
            super(v);
            // label = (TextView) v.findViewById(R.id.carrer_cardview_text);
            //  mTextView = (TextView) v;

            fest_data_fest_workshop= v.findViewById(R.id.fest_data_fest_workshop);
            fest_data_fest_eventdetails= v.findViewById(R.id.fest_data_fest_eventdetails);
            fest_data_fest_paper= v.findViewById(R.id.fest_data_fest_paper);
    ...
    public FestsEventDetailsAdaptor(OnItemClickListener listener, Context contextForFragment, Bitmap[] arrayOfBitmap, ArrayList<HashMap<String, String>> stringData) {
    ...
    @Override
    public FestsEventDetailsAdaptor.carrerGuidanceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType ==3) {
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.fests_eventdetails_adaptor, parent, false);
...
if (!(stringDataAdaptor.isEmpty())){
  ...
  //  String sourceString0 = dandeval.get("fest_college_name");
   ...
   // String sourceString3 = "<b>" + "Fest Info: " + "</b> " + dandeval.get("CLG_FEST_INFO");
    ...
    holder.fest_data_fest_eventdetails.setText(Html.fromHtml(dandeval.get("fest_event")));
    holder.fest_data_fest_workshop.setText(Html.fromHtml(dandeval.get("fest_workshop")));
    holder.fest_data_fest_paper.setText(Html.fromHtml(dandeval.get("fest_paper")));
