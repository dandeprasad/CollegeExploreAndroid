...
public class FestsMainHeaderAdsAdaptor extends RecyclerView.Adapter<FestsMainHeaderAdsAdaptor.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            imageView = v.findViewById(R.id.img_mainAdsHeader);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public FestsMainHeaderAdsAdaptor(String[] maincontents, Bitmap[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public FestsMainHeaderAdsAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.home_header_ads_child, parent, false);
