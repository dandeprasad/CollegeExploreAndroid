...
public class FestsOverviewAdaptor extends RecyclerView.Adapter<FestsOverviewAdaptor.carrerGuidanceViewHolder>  {
  ...
  public  ArrayList<HashMap> ImagesArray=new ArrayList<HashMap>();
    ...
    public FestsOverviewAdaptor(OnItemClickListener listener, Context contextForFragment, Bitmap[] arrayOfBitmap, ArrayList<HashMap<String, String>> stringData) {
    ...
    @Override
    public FestsOverviewAdaptor.carrerGuidanceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
 ...
 *//*               if ( arrayOfBitmaptest[5]!=null)
           ...
           holder.fest_data_college_website.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mListener.onClick(view, position,  dandeval1.get("college_website"));
                }
            });
