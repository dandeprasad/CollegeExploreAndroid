...
public class FestsReachUs extends Fragment implements FestsReachUsAdaptor.OnItemClickListener {
    String  COLLEGE_ID;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static FestsReachUs newInstance(String COLLEGE_ID) {
        FestsReachUs f = new FestsReachUs();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new FestsReachUsAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_FESTS_REACHUS";
        String ACTION_ID = "GET_FESTS_REACHUS";
            ...
            if(result.equalsIgnoreCase("UNABLE_TO_REACH_WEB"))
            {
                ...
                try {
                    ...
                    for (int i = 0; i < lenghtl; i++) {
                        ...
                        String college_location = Util.Nullcheck((String) clgdata.get("college_location"));
                        String fest_reach = Util.Nullcheck((String) clgdata.get("fest_reach"));
                        String Fest_contact_persons = Util.Nullcheck((String) clgdata.get("Fest_contact_persons"));
...
if(null!=banner_logos) {
    Picasso.with(contextForFragment).load(banner_logos).into(dande);
                        ...
                        param_aux.put("college_location", college_location);
                        param_aux.put("fest_reach", fest_reach);

                        param_aux.put("Fest_contact_persons", Fest_contact_persons);
