...
public class FestsReachUsAdaptor extends RecyclerView.Adapter<FestsReachUsAdaptor.carrerGuidanceViewHolder>  {
  ...
  public  ArrayList<HashMap> ImagesArray=new ArrayList<HashMap>();
    ...
    public  class carrerGuidanceViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView fest_data_Fest_contact_persons,fest_data_fest_reach,fest_data_college_location;
        public carrerGuidanceViewHolder(View v) {
            super(v);
            // label = (TextView) v.findViewById(R.id.carrer_cardview_text);
            //  mTextView = (TextView) v;

            fest_data_Fest_contact_persons= v.findViewById(R.id.fest_data_Fest_contact_persons);
            fest_data_fest_reach= v.findViewById(R.id.fest_data_fest_reach);
            fest_data_college_location= v.findViewById(R.id.fest_data_college_location);
    ...
    public FestsReachUsAdaptor(OnItemClickListener listener, Context contextForFragment, Bitmap[] arrayOfBitmap, ArrayList<HashMap<String, String>> stringData) {
    ...
    @Override
    public FestsReachUsAdaptor.carrerGuidanceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType ==3) {
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.fests_reachus_adaptor, parent, false);
...
if (!(stringDataAdaptor.isEmpty())){
  ...
  //  String sourceString0 = dandeval.get("fest_college_name");
   ...
   // String sourceString3 = "<b>" + "Fest Info: " + "</b> " + dandeval.get("CLG_FEST_INFO");
    ...
    holder.fest_data_Fest_contact_persons.setText(Html.fromHtml(dandeval.get("Fest_contact_persons")));
    holder.fest_data_fest_reach.setText(Html.fromHtml(dandeval.get("fest_reach")));
    holder.fest_data_college_location.setText(Html.fromHtml(dandeval.get("college_location")));
