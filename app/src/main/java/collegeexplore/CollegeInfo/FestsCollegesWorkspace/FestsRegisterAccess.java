...
public class FestsRegisterAccess extends Fragment implements FestsRegisterAccessAdaptor.OnItemClickListener {
    String  COLLEGE_ID;
    ...
    FestsRegisterAccessAdaptor mAdapter;
    ImageView imageView;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static FestsRegisterAccess newInstance(String COLLEGE_ID) {
        FestsRegisterAccess f = new FestsRegisterAccess();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new FestsRegisterAccessAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_FESTS_REGIS_ACCESS";
        String ACTION_ID = "GET_FESTS_REGIS_ACCESS";
            ...
            if(result.equalsIgnoreCase("UNABLE_TO_REACH_WEB"))
            {
                ...
                try {
                    ...
                    for (int i = 0; i < lenghtl; i++) {
                        ...
                        String fest_regis_url = Util.Nullcheck((String) clgdata.get("fest_regis_url"));
                        String fest_Regis_fees = Util.Nullcheck((String) clgdata.get("fest_Regis_fees"));
                        String fest_dead_registration = Util.Nullcheck((String) clgdata.get("fest_dead_registration"));
                        String fest_sponsors = Util.Nullcheck((String) clgdata.get("fest_sponsors"));
                        String fest_guest = Util.Nullcheck((String) clgdata.get("fest_guest"));
...
if(null!=banner_logos) {
    Picasso.with(contextForFragment).load(banner_logos).into(dande);
                        ...
                        param_aux.put("fest_regis_url", fest_regis_url);
                        param_aux.put("fest_Regis_fees", fest_Regis_fees);

                        param_aux.put("fest_dead_registration", fest_dead_registration);
                        param_aux.put("fest_sponsors", fest_sponsors);
                        param_aux.put("fest_guest", fest_guest);
    ...
    public void onClick(View view, int position, String clg_id) {
        int x = view.getId();

        selectItem(position,clg_id);
    }
    private void selectItem(int position,String clg_id ){
/*

        final String UniqueKey = clg_id;
ArrayList<String> datatohost=new ArrayList<String>();
        ...
        Fragment fr =  PlaceSecondFragment.newInstance(position, UniqueKey,datatohost);
        FragmentTransaction fragmentTransaction;
        fragmentTransaction = getActivity().getSupportFragmentManager().beginTransaction();
        fragmentTransaction.setCustomAnimations(android.R.anim.fade_in,
                android.R.anim.fade_out);
        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
        fragmentTransaction.add(R.id.view_onclick_framecutt1,fr);
