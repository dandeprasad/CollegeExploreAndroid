...
public class Fests_EventDetails extends Fragment implements FestsEventDetailsAdaptor.OnItemClickListener {
    String  COLLEGE_ID;
    ...
    FestsEventDetailsAdaptor mAdapter;
    ImageView imageView;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static Fests_EventDetails newInstance(String COLLEGE_ID) {
        Fests_EventDetails f = new Fests_EventDetails();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new FestsEventDetailsAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_FESTS_EVENTDETAILS";
        String ACTION_ID = "GET_FESTS_EVENTDETAILS";
        new GetStringFestsTask(WORKSPACE_ID,FUNCTION_ID,ACTION_ID,COLLEGE_ID).execute(jsonurl);
      //  new GetStringFestsTask(WORKSPACE_ID,FUNCTION_ID,ACTION_ID).execute(jsonurl);
            ...
            if(result.equalsIgnoreCase("UNABLE_TO_REACH_WEB"))
            {
                ...
                try {
                    ...
                    for (int i = 0; i < lenghtl; i++) {
                        ...
                        String fest_event = (String) clgdata.get("fest_event");
                        String fest_workshop = (String) clgdata.get("fest_workshop");
                        String fest_paper = (String) clgdata.get("fest_paper");
...
if(null!=banner_logos) {
    Picasso.with(contextForFragment).load(banner_logos).into(dande);
                        ...
                        param_aux.put("fest_event", fest_event);
                        param_aux.put("fest_workshop", fest_workshop);

                        param_aux.put("fest_paper", fest_paper);
