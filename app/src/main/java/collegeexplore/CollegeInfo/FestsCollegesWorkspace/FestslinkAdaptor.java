...
public class FestslinkAdaptor extends RecyclerView.Adapter<FestslinkAdaptor.carrerGuidanceViewHolder>  {
  ...
  public  ArrayList<HashMap> ImagesArray=new ArrayList<HashMap>();
    ...
    public  class carrerGuidanceViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView fest_data_links,fest_data_website,fest_data_college_website,fest_data_fest_regis_url;
        public carrerGuidanceViewHolder(View v) {
            super(v);
            // label = (TextView) v.findViewById(R.id.carrer_cardview_text);
            //  mTextView = (TextView) v;

            fest_data_links= v.findViewById(R.id.fest_data_links);
            fest_data_website= v.findViewById(R.id.fest_data_website);
            fest_data_college_website= v.findViewById(R.id.fest_data_college_website);
            fest_data_fest_regis_url= v.findViewById(R.id.fest_data_fest_regis_url);
    ...
    public FestslinkAdaptor(OnItemClickListener listener, Context contextForFragment, Bitmap[] arrayOfBitmap, ArrayList<HashMap<String, String>> stringData) {
    ...
    @Override
    public FestslinkAdaptor.carrerGuidanceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType ==3) {
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.fests_regislinks_adaptor, parent, false);
...
if (!(stringDataAdaptor.isEmpty())){
  ...
  //  String sourceString0 = dandeval.get("fest_college_name");
   ...
   // String sourceString3 = "<b>" + "Fest Info: " + "</b> " + dandeval.get("CLG_FEST_INFO");
    ...
    holder.fest_data_links.setText(Html.fromHtml(dandeval.get("fest_links")));
    holder.fest_data_website.setText(Html.fromHtml(dandeval.get("fest_website")));
    holder.fest_data_college_website.setText(Html.fromHtml(dandeval.get("college_website")));
    holder.fest_data_fest_regis_url.setText(Html.fromHtml(dandeval.get("fest_regis_url")));




    holder.fest_data_links.setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                HashMap <String,String> dandeval1= stringDataAdaptor.get(position);
                                                String url =dandeval1.get("fest_links");
...
/*
    ...
    holder.fest_data_website.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            HashMap <String,String> dandeval1= stringDataAdaptor.get(position);
            String url =dandeval1.get("fest_website");
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(url));
            Toast.makeText(contextAdaptor,"You are redirecting to fest page of particular college" , Toast.LENGTH_LONG).show();
            contextAdaptor.startActivity(i);
...
/*
    ...
    holder.fest_data_college_website.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            HashMap <String,String> dandeval1= stringDataAdaptor.get(position);
            String url =dandeval1.get("college_website");
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(url));
            Toast.makeText(contextAdaptor,"You are redirecting to fest page of particular college" , Toast.LENGTH_LONG).show();
            contextAdaptor.startActivity(i);
...
/*
    ...
    holder.fest_data_fest_regis_url.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            HashMap <String,String> dandeval1= stringDataAdaptor.get(position);
