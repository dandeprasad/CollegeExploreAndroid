...
public class Festslinks extends Fragment implements FestslinkAdaptor.OnItemClickListener {
    String  COLLEGE_ID;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static Festslinks newInstance(String COLLEGE_ID) {
        Festslinks f = new Festslinks();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAdapter = new FestslinkAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
...
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_FESTS_REGIS_LINKS";
        String ACTION_ID = "GET_FESTS_REGIS_LINKS";
            ...
            if(result.equalsIgnoreCase("UNABLE_TO_REACH_WEB"))
            {
                ...
                try {
                    ...
                    for (int i = 0; i < lenghtl; i++) {
                        ...
                        String fest_links = Util.Nullcheck((String) clgdata.get("fest_links"));
                        String fest_website = Util.Nullcheck((String) clgdata.get("fest_website"));
                        String college_website = Util.Nullcheck((String) clgdata.get("college_website"));
...
if(null!=banner_logos) {
    Picasso.with(contextForFragment).load(banner_logos).into(dande);
                        ...
                        param_aux.put("fest_links", fest_links);
                        param_aux.put("fest_website", fest_website);
