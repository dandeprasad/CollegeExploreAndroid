...
public class ListOfNitsNews extends RecyclerView.Adapter<ListOfNitsNews.ViewHolder> {
    ...
    public ListOfNitsNews( String[] maincontents,Integer[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public ListOfNitsNews.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                    int viewType) {
        // create a new view
