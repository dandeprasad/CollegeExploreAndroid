...
public class ListofAllNotifications extends RecyclerView.Adapter<ListofAllNotifications.ViewHolder> {
    ...
    public ListofAllNotifications(String[] maincontents, HashMap imageId, OnItemClickListener listener,Context contexthere) {
    ...
    @Override
    public ListofAllNotifications.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                        int viewType) {
        // create a new view
