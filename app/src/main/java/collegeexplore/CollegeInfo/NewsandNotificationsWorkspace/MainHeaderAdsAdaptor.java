...
public class MainHeaderAdsAdaptor extends RecyclerView.Adapter<MainHeaderAdsAdaptor.ViewHolder> {
    ...
    public MainHeaderAdsAdaptor(String[] maincontents, Bitmap[] imageId, OnItemClickListener listener) {
    ...
    @Override
    public MainHeaderAdsAdaptor.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
        // create a new view
