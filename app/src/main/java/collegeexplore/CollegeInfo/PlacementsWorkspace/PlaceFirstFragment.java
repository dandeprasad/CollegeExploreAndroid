...
public class PlaceFirstFragment extends Fragment implements PlaceFirstAdaptor.OnItemClickListener {
    int mNum;
   ...
   // String StringData[]=new  String[7];
     ...
     */
    public static PlaceFirstFragment newInstance() {
        PlaceFirstFragment f = new PlaceFirstFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle(R.string.streams);
      ...
      /*  ProgressBar spinner = new android.widget.ProgressBar(
       ...
       //contextForFragment.findViewById(R.id.loadingPanel).setVisibility(View.VISIBLE);
        ...
        //StringData.clear();
        mAdapter = new PlaceFirstAdaptor(this,contextForFragment,arrayOfBitmap,StringData);
        ...
        try {
            ...
            jsonurl= server.concat("/CutoffsFirstString");
        } catch (IOException e) {
            e.printStackTrace();
        }
/*        for(int i =0;i<=9;i++)
        ...
        String FUNCTION_ID = "GET_CUTOFFS_FIRST";
        String ACTION_ID = "GET_CUTOFFS_FIRST_STRING";
            ...
            if(result.equalsIgnoreCase("UNABLE_TO_REACH_WEB"))
            {
                ...
                try {
                    ...
                    for (int i = 0; i < lenghtl; i++) {
                        ...
                        String STREAM_IMAGE = (String) clgdata.get("STREAM_IMAGE");
                        String STREAM_ID = (String) clgdata.get("STREAM_ID");

                        HashMap<String, String> param_aux = new HashMap<String, String>();

                        param_aux.put("STREAM", STREAM);
                        param_aux.put("STREAM_ID", STREAM_ID);

                        param_aux.put("STREAM_IMAGE", STREAM_IMAGE);
