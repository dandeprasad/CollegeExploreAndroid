            ...
            public void onClick(View arg0) {
              ...
              //  PASSWORD =  password.getText().toString();
                ...
                try {
                    ...
                    userdata.put("USER_POSTED_MAIL",User_Email);
                    userdata.put("USER_POSTED_NAME",User_Name);
                ...
                try {
                    JSONObject obj = new JSONObject(ing);
                        ...
                        if(StringNews.equalsIgnoreCase("SUCCESS")){
                            Toast.makeText(getApplicationContext(), R.string.posted_successfully, Toast.LENGTH_LONG).show();
