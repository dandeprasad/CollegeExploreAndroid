package collegeexplore.CollegeInfo.RatingsAndReviews;
...
public class UserRatingEntry extends Fragment  {
...
RatingBar ratingbar,    campusratingBar1,PlacementsratingBar1, EnvironmentratingBar1;
    ...
    EditText  riviewdata,reveiwhead;
...
Button button1;
     ...
     */
    public static UserRatingEntry newInstance(String collegeidToPass,String COLLEGE_NAMEJSON) {
        UserRatingEntry f = new UserRatingEntry();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.user_rating_entry, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Rating & Review");
        ...
        TextView dan = xtest.findViewById(R.id.college_name_review);

        dan.setText(Html.fromHtml("<b>College Name:</b>"+COLLEGE_NAMEJSON));
        ratingbar=(RatingBar)xtest.findViewById(R.id.facratingBar1);
        campusratingBar1=(RatingBar)xtest.findViewById(R.id.campusratingBar1);
        PlacementsratingBar1=(RatingBar)xtest.findViewById(R.id.PlacementsratingBar1);
        EnvironmentratingBar1=(RatingBar)xtest.findViewById(R.id.EnvironmentratingBar1);
...
String fac_rat=String.valueOf(ratingbar.getRating());
                String campus_rat=String.valueOf(campusratingBar1.getRating());
                String place_rat=String.valueOf(PlacementsratingBar1.getRating());
                String environ_rat=String.valueOf(EnvironmentratingBar1.getRating());
String reveiwcpation = reveiwhead.getText().toString();
                ...
                try {
                    ...
                    jsonObject.put("college_name", COLLEGE_NAMEJSON);
                    jsonObject.put("CLG_ID", COLLEGEIDJSON);
                    jsonObject.put("fac_rat", fac_rat);
                    jsonObject.put("campus_rat", campus_rat);
                    jsonObject.put("place_rat", place_rat);
                    jsonObject.put("environ_rat", environ_rat);

                    jsonObject.put("reveiwcpation", reveiwcpation);
                    jsonObject.put("reveiwdesc", reveiwdesc);
...
UserLoginManager dfd = new UserLoginManager(contextForFragment);
                ...
                try {
                    ...
                    serverUrl= server.concat("/Userreviews");
