...
public class NotifyDetailFragment extends Fragment {
    ...
    public static NotifyDetailFragment newInstance(HashMap animalItem, String transitionName) {
        NotifyDetailFragment f = new NotifyDetailFragment();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            detailTextView.setText(Html.fromHtml(animalItem.get("DATA3")));
        }
        if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.N) {
            detailTextView.setText(Html.fromHtml(animalItem.get("DATA3"),Html.FROM_HTML_MODE_COMPACT));
       ...
       // data_header_text.setText(animalItem.get("NEWS_HEADER"));
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            data_header_text.setText(Html.fromHtml(animalItem.get("DATA2")));
        }
        if (Build.VERSION.SDK_INT >=Build.VERSION_CODES.N) {
            data_header_text.setText(Html.fromHtml(animalItem.get("DATA2"),Html.FROM_HTML_MODE_COMPACT));
 }
        ...
        Picasso.with(getContext())
                .load(animalItem.get("NOTIFY_IMAGE")).resize(600, 200)
                .noFade()
