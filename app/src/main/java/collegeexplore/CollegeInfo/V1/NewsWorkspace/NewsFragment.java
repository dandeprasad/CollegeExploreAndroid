...
public static String currentURL = "http://collegeexplore.in";
    @Override
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        pagerAdapter = new PagerAdapterImpl(StringData,contextForFragment);
        ...
        viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                currentURL = StringData.get(i).get("WEBSITE_LINKS");
            }
                ...
                if (!result.equals("")) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < count; i++) {
                            ...
                            String WEBSITE_LINKS = Util.Nullcheck((String) clgdata.get("WEBSITE_LINKS"));
                            ...
                            hashMap.put("WEBSITE_LINKS", WEBSITE_LINKS);
                ...
                if (!result.equals("")) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < lenghtl; i++) {
                            ...
                            StringData.add(hashmap);
                            //setting for initial current item
                            currentURL = StringData.get(0).get("WEBSITE_LINKS");
                        }
